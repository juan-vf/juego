...
create(){
    const map = this.make.tilemap({ key: "mapL2" });
    const tilesetBelow2  = map.addTilesetImage("sky22", "fondo3");
    const tilesetBelow3  = map.addTilesetImage("ground", "plataforma02");
...
update(){
      if (lunas.countActive(true) === 1) { 
        this.scene.start("Elec2", { score: score });
      }
